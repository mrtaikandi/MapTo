...
internal static class FileBuilderExtensions
{
    public static ITestFileBuilder AddFile(
        ...
        AddFile(builder, new TestFileBuilder(fileName, ns, usings ?? [], autoGenerated, supportNullableReferenceTypes));

    public static ITestFileBuilder AddEmptyFile(this ITestSourceBuilder builder, string fileName = "", bool supportNullableReferenceTypes = true) =>
        AddFile(builder, new TestFileBuilder(fileName, string.Empty, [], false, supportNullableReferenceTypes));
